...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [ProductsComponent,ForCComponent,MydirectivesComponent,FormsModule,RouterOutlet,BannerComponent, HeaderComponent,CategoriesComponent, FooterComponent,NavComponent],
